...
const styles = StyleSheet.create({
  ...
  slotVoters: { flex: 1, flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center' },
  slotAvatar: { width: 18, height: 18, borderRadius: 9, marginRight: 2 },
  checkIcon: { marginLeft: 5 },
  rankingSidebar: { width: 80, borderRadius: 18, padding: 10, height: '100%', alignSelf: 'flex-start' },
  rankingHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 10 },
  rankingTitle: { fontSize: 10, fontWeight: 'bold' },
  rankingItem: { marginBottom: 10 },
  rankText: { fontSize: 9, fontWeight: '600' },
  rankTime: { fontSize: 12, fontWeight: '700' },
  rankVotes: { fontSize: 10, fontWeight: '800' },
  footer: { marginTop: 15, paddingTop: 15, borderTopWidth: 1 },
  participationRow: { flexDirection: 'row', alignItems: 'flex-start' },
  footerLabel: { fontSize: 11, fontWeight: 'bold', width: 60 },
  namesRow: { flex: 1, flexDirection: 'row', flexWrap: 'wrap' },
  participantName: { fontSize: 11, marginRight: 6 },
